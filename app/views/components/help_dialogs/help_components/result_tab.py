...
class ResultTabComponent(BaseTabComponent):
    ...
    def init_content(self):
        ...
        features_section = HelpSectionComponent(
            number=1,
            title="Main Features",
            description="The Results page offers several tools for analysis:"
        )
        ...
        features_section.add_list_item("Export Data: Click the 'Export' button to save results as a CSV file.")
        features_section.add_list_item("Generate Report: Click the 'Report' button to create a comprehensive report.")
        ...
        buttons_layout.addStretch(1)  # 오른쪽 공간 채우기
