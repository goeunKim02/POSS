...
def calc_plan_retention():
    ...
    for idx,row in df_result.iterrows():
        ...
        df_result.loc[idx,'Next item MFG'] = int(max_mfg)
        df_demand_item_mfg[row['Item']] -= int(max_mfg)
    ...
    for idx,row in df_result.iterrows():
        ...
        df_result.loc[idx,'Next RMC MFG'] = int(max_mfg)
        df_demand_rmc_mfg[rmc] -= int(max_mfg)
